...
define({
  ...
  //suites: [ 'tests/all' ],
  suites: [ 'tests/we' ],
  //suites: [ 'tests/all','tests/we' ],//coverage report reduce 50%

  //reporters: [
  //  { id: 'tests/all', filename: 'report.xml' }
  //],
  ...
  functionalSuites: [ 'tests/functional/Todo','tests/functional/TodoWE' ],
